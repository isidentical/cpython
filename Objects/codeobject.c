...
positionsiter_next(positionsiterator* pi)
{
    ...
    int start_line = PyCode_Addr2Line(pi->pi_code, pi->pi_offset);
    int end_line = PyCode_Addr2EndLine(pi->pi_code, pi->pi_offset);
    int start_col = PyCode_Addr2Offset(pi->pi_code, pi->pi_offset);
    int end_col = PyCode_Addr2EndOffset(pi->pi_code, pi->pi_offset);
