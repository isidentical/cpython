...
def write_header(f, mod, metadata):
    ...
    prototyper = PrototypeVisitor(f, metadata = metadata)
    prototyper.visit(mod)
    f.write("\n")
...
def write_source(f, mod, metadata):
